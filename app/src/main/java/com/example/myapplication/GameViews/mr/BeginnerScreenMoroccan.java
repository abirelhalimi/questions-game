...
public class BeginnerScreenMoroccan extends Screen {
    ...
    public BeginnerScreenMoroccan(Game game) throws IOException {
        super(game);
    ...
    public void handleTouchDown(int x, int y, int pointer) {
        ...
        if (s != null && s.equals(next)) {
            try {
                game.setScreen(new BeginnerScreenMoroccan((MainActivityEng) game));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
