...
public class IntermediateScreenMoroccan extends Screen {
    ...
    public IntermediateScreenMoroccan(Game game) throws IOException {
        super(game);
    ...
    public void handleTouchDown(int x, int y, int pointer) {
        ...
        if (s != null && s.equals(next)) {
            ...
            try {
                game.setScreen(new IntermediateScreenMoroccan((MainActivityEng) game));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
